...
def get_model_answer_pope(args, data, model, answer_file):
    ...
    print(f'----POPE----\nSaved responses to {os.path.dirname(answer_file)}')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", choices=['LLaVA-7B', 'MiniGPT4', 'mPLUG_Owl2'], default="LLaVA-13B") 
    parser.add_argument("--model_path", default="./output/edited_model/LLaVA-13B-top32-8-24-test") 
    # parser.add_argument("--model_path", default="/workspace/Nullu-13b/llava-v1.5-13b") 
